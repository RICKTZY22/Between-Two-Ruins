...
function Ch01JosefContent() {
  return (
    <>
      ...
      <p>The lunch rush had a sound.</p>

      <p>
        Josef Antonio de Luna knew it the way a fisherman knows the tide. Not by thinking, but by
        feel. The clatter of trays, the shriek of the fryer, the low roar of a dozen conversations
        stacked on top of each other like sheets of dirty glass. He moved through all of it without
        fuss. Hands working. Eyes down. A burger here, a refill there. The work was simple and the
        simplicity was the point.
      </p>

      <p>
        He had worked at Burger Stop for three years and four months. Nobody asked him to count. He
        just had.
      </p>

      <p>
        The place sat on the corner of Malugay and the highway, wedged between a pharmacy that
        never seemed to close and a tire shop that never seemed to open. Inside it smelled of salt
        and cooking oil and the faint ghost of industrial cleaner. Fluorescent lights. Laminated
        menus. The same four songs cycling through the speakers at a volume just loud enough to be
        annoying and just low enough that nobody ever bothered to complain.
      </p>
      ...
      <p>
        What people did not see, what he did not let them see, was that the containment was not
        natural. It was constructed. Built piece by piece over years, the way you board up a window
        after the glass is already gone.
      </p>
      ...
      <p>
        He refilled her water without being asked. Then, because it was his job and because
        something in him could not just walk away, he asked quietly and carefully if there was
        anything else he could get for her.
      </p>

      <p>She looked up.</p>

      <p>
        <em>&ldquo;Who the fuck are you?&rdquo;</em> The words came out sharp and fast, like
        something she had been holding at pressure. <em>&ldquo;Why do you even care? Just leave me
        alone. Mind your own business.&rdquo;</em>
      </p>
      ...
      <p>
        He pressed two fingers to the edge of the counter and held them there until the sensation
        passed.
      </p>
      ...
      <p>He locked up at nine.</p>

      <p>
        The street was quieter now, smudged with orange from the lampposts. He walked the twenty
        minutes home the way he always walked it. Headphones in, music off, hands in his pockets.
        There was a version of Josef who listened to music on the walk home. He had not been that
        version in a long time.
      </p>

      <p>
        He passed the pharmacy. The tire shop. A dog sleeping outside a gate. A child&rsquo;s
        sandal left on the pavement, alone, inexplicable.
      </p>
...
export const ch01Josef: Chapter = {
  id: 'ch01-josef',
  number: 1,
  title: 'Josef',
  decayIntensity: 0.0,
  content: <Ch01JosefContent />,
};
